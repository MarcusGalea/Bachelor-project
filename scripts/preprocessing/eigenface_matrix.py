...
for kernel in os.listdir(r"C:\Users\Marcu\OneDrive - Danmarks Tekniske Universitet\DTU\6. Semester\Bachelorprojekt\Data\AllSeries\Kernels\All Defects\\"):
...
N,M = A.shape
mean = A.mean(axis=1)
Y = A - np.tile(mean.reshape(-1,1),(1,N))
#%%
...
plt.plot(np.arange(1,n+1),list(rho.cumsum()[:10]))
