...
#train_sampler = MPerClassSampler(y_train, m, batch_size=batch_size, length_before_new_iter=10000)
...
y_pred = net_m.predict(X = Subset(test_split,np.arange(20)))
y_pred_proba = net_m.predict_proba(test_split)
