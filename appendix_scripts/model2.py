...
Script name: model2.py
Script function: Script that defines a Mask R-CNN as well as custom dataset. The script both trains, saves and evaluates the model
"""
...
def get_model_instance_segmentation(num_classes):
    ...
    anchor_generator = AnchorGenerator(
                        ...
                        sizes=(tuple([(16, 64, 256) for _ in range(1)])),
                        aspect_ratios=(tuple([(0.1, 1.0, 3.0, 6.0) for _ in range(1)])))
